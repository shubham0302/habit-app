// ignore_for_file: avoid_unnecessary_containers, avoid_print, deprecated_member_use
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    onTap: () async {
                      ...
                      //     context, index);
                      // TODO : Show this dialogue once task is completed
                      // HabbitCompleteTaskCustomDialogBox(
                      //     context, index, ScreenshotController());

                      // var id = habbitSelectController
                      //     .tasks
                      //     .where((p0) =>
                      // p0.archive ==
                      //     false)
                      ...
                      // This one is for the set the model to the state and also set the task name and description
                      habbitSelectController.selectedTaskIndex.value = index;

                      // This one is for the set the evaluate
                      habbitSelectController.selectEvaluate.value =
                      ...
                      // This one is for the categoryIcon and its value
                      habbitSelectController.categoryId.value =
                          habbitSelectController
                              .tasks
                              .where((p0) =>
                          p0.archive ==
                      ...
                      // This one is for the startDate
                      habbitSelectController.startDate.value =
                          habbitSelectController
                              .tasks
                              .where((p0) =>
                          p0.archive ==
                      ...
                      // This one is for the endDate
                      habbitSelectController.endDate.value =
                          habbitSelectController
                              .tasks
                              .where((p0) =>
                          p0.archive ==
                      ...
                      // This one is for set the repetation
                      var allRemindersFromDatabase = await dbController.appDB
                          .getRecurringRepetitions();

                      habbitSelectController.updateRepetation.value =
                          allRemindersFromDatabase.firstWhere((element) =>
                          element.id ==
                              habbitSelectController
                                  .tasks
                                  .where((p0) =>
                      ...
                      // This one is for the reminders
                      var remindersFromTheDB = await dbController.appDB
                          .getRemindersHabbit();

                      habbitSelectController.remList.value = remindersFromTheDB
                          .where((element) =>
                      element.habitId == habbitSelectController
                          .tasks
                          .where((p0) =>
                      p0.archive ==
                          false)
                      ...
                      // This one is for the priority
                      habbitSelectController.updatePriority.value =
                          habbitSelectController
                              .tasks
                              .where((p0) =>
                          p0.archive ==
                                ...
                                children: [
                                  SlidableAction(
                                    ...
                                    categoryController.categories
                                        .firstWhere((element) =>
                                    element.id ==
                                        habbitSelectController.tasks.where((
                                            p0) => p0.archive == false)
                                            .toList()
                                            .where((p0) => p0.archive == false)
                                            .toList()[index].categoryId)
                                        .color],
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  element.id ==
                                                      ...
                                                      .color]
                                                      : categoryController
                                                      .iconLightColor[categoryController
                                                      .categories
                                                      .firstWhere((element) =>
                                                  element.id ==
                                                      habbitSelectController
