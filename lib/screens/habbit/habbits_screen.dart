        ...
        child: Padding(
          ...
          child: Obx(
            () => habbitSelectController.tasks.isEmpty
                ...
                : habbitSelectController.tasks.toList() == []
                    ? SizedBox()
                    : AnimationLimiter(
                                                            ...
                                                            color: color.brightness ==
                                                                ...
                                                                : categoryController
                                                                    ...
                                                                    categoryController
                                                                        .categories
                                                                        .firstWhere(
                                                                            (element) => element.id == habbitSelectController.tasks[index].categoryId)
                                                                        .color]),
                                                      ),
                                                      SW.medium(),
                                                      Column(
                                                              ...
                                                              Container(
                                                                  ...
                                                                  child: switchController
                                                                      ...
                                                                      ? DescriptionText(
                                                                          text: habbitSelectController
                                                                              .repetitionsData
                                                                              .firstWhere((element) => element.id == habbitSelectController.tasks[index].repetitonId)
                                                                              .type,
                                                                          isBold:
                                                                              true,
                                                                          isColor:
