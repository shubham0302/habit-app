...
void ReminderCustomDialogBox(BuildContext context) {
  ...
  void _showTimePicker() {
    ...
    showTimePicker(
      ...
      addHabbitSelectController.reminderTime.value = v!;
    });
  }
                  ...
                  children: [
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          if (addHabbitSelectController
                                              .customDays
                                              .contains('SUN')) {
                                            addHabbitSelectController.customDays
                                                .remove('SUN');
                                          } else {
                                            addHabbitSelectController.customDays
                                                .add('SUN');
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            addHabbitSelectController.customSound.value == true
                                ? addHabbitSelectController.customSound.value =
                                    false
                                : addHabbitSelectController.customSound.value =
                                    true;
                            print(addHabbitSelectController.customSound.value);
                          },
                          child: Obx(
                            () => Icon(
                              addHabbitSelectController.customSound.value
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            addHabbitSelectController.customVibration.value ==
                                    true
                                ? addHabbitSelectController
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            addHabbitSelectController.customAlarm.value == true
                                ? addHabbitSelectController.customAlarm.value =
                                    false
                                : addHabbitSelectController.customAlarm.value =
                                    true;
                            print(addHabbitSelectController.customAlarm.value);
                          },
                          child: Obx(
                            () => Icon(
                              addHabbitSelectController.customAlarm.value
