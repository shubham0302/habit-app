...
import 'package:habbit_app/screens/task_screen/archive_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: GlobalPadding(
              child: Obx(
            () => addTaskController.taskArcive.value == false
                ? Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Obx(
                                                        () =>
                                                          ...
                                                          itemCount: addTaskController.dataTasks[addTaskController.taskTimes[index]] !=
                                                                      null &&
                                                                  addTaskController
                                                                      .dataTasks[
                                                              ...
                                                              onTap: () {
                                                                ...
                                                                addTaskController.updateArcive(
                                                                    ...
                                                                    addTaskController
                                                                        ...
                                                                        .where((element) => element.archive == false)
                                                                        .toList()[i]
                                                                        .taskDate,
                                                                    addTaskController.dataTasks[addTaskController.taskTimes[index]]!.where((element) => element.archive == false).toList()[i].taskStatus,
                                                                    addTaskController.dataTasks[addTaskController.taskTimes[index]]!.where((element) => element.archive == false).toList()[i].pendingTask,
                                                                    addTaskController.dataTasks[addTaskController.taskTimes[index]]!.where((element) => element.archive == false).toList()[i].archived,
                                                                    addTaskController.dataTasks[addTaskController.taskTimes[index]]!.where((element) => element.archive == false).toList()[i].reminderId);
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      IconWidget(
                                                                          color: categoryController
                                                                              .categories
                                                                              .firstWhere((element) => element.id == addTaskController.dataTasks[addTaskController.taskTimes[index]]!.where((element) => element.archive == false).toList()[i].categoryId)
                                                                              .color,
                                                                          icon: categoryController.categories.firstWhere((element) => element.id == addTaskController.dataTasks[addTaskController.taskTimes[index]]!.where((element) => element.archive == false).toList()[i].categoryId).icon),
                                                        ...
                                                        onTap: () {
                                                          recurringTaskController.updateArchive(
                                                              ...
                                                              recurringTaskController
                                                                  ...
                                                                  .toList()[index]
                                                                  .rDescription,
                                                              recurringTaskController.tasks.where((p0) => p0.archive == false).toList()[index].rTaskName,
                                                              recurringTaskController.tasks.where((p0) => p0.archive == false).toList()[index].reminderId,
                                                              recurringTaskController.tasks.where((p0) => p0.archive == false).toList()[index].repetitonId,
                                                              recurringTaskController.tasks.where((p0) => p0.archive == false).toList()[index].startDate);
                                                        },
                                                        child: Row(
                                                          children: [
                                                            // Container(
                                                                ...
                                                                Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      color: categoryController
                                                                          .iconColor[categoryController
                                                                              .categories
                                                                              .firstWhere((element) => element.id == recurringTaskController.tasks.where((p0) => p0.archive == false).toList()[index].categoryId)
                                                                              .color]
                                                                          .withOpacity(0.2),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    color: categoryController.iconColor[categoryController
                                                                        ...
                                                                        .firstWhere((element) =>
                                                                            element.id ==
                                                                            recurringTaskController.tasks.where((p0) => p0.archive == false).toList()[index].categoryId)
                                                                        .color],
                                                                  ),
                                                                )
                                                              ],
